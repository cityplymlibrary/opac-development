	...
	class miniSpaCls {
		...
		renderPage() {
			...
			if(this.cd == '#!/' || this.cd == '#!/hp') {
				...
				this.pageFactory('<section class=\"-ccp-cloudy-section\"><div class=\"-ccp-container\"><div class=\"-ccp-inner-lg\"><h2 class=\"-ccp-numeral\">1<\/h2><h2 class=\"-ccp-heading-u\">Congratulations!<\/h2><p>A self-test of this SPA has been completed, and I am delighted to inform you that the script is functioning as expected.<\/p><\/div><\/div><\/section>');
